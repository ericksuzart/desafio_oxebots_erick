...
def generate_launch_description():
    ...
    args = [
        DeclareLaunchArgument('name', default_value='robot_controller', description='node name'),
        DeclareLaunchArgument('namespace', default_value='', description='node namespace'),
        DeclareLaunchArgument(
            'params',
            default_value=os.path.join(
                get_package_share_directory('desafio_oxebots_erick'), 'config', 'params.yml'
            ),
